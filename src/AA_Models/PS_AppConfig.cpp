...
namespace PS{
	...
	//====================================================================================
	svec3f CAppConfig::readVec3f(DAnsiStr section, DAnsiStr variable)
	{
		DAnsiStr strVal;
		svec3f res;
		if(readValue(section, variable, strVal))
	...
	//====================================================================================
	void CAppConfig::writeVec3f(DAnsiStr section, DAnsiStr variable, svec3f val)
	{
	...
	//====================================================================================
	svec4f CAppConfig::readVec4f(DAnsiStr section, DAnsiStr variable)
	{
		DAnsiStr strVal;
		svec4f res;
		if(readValue(section, variable, strVal))
	...
	//====================================================================================
	void CAppConfig::writeVec4f(DAnsiStr section, DAnsiStr variable, svec4f val)
	{
